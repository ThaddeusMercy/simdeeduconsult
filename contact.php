...
<body onscroll="navify()" onload="whatsappshow()">
    ...
    <div class="mother hidden-lg">
        <div class="mobile-nav-closed" id="mobileNav">
            ...
            <div>
                ...
                <a href="#" class="color-3"> Contact us</a>
            </div>
        </div>
    </div>
        ...
        <div class="dark-scarf-3">
            <div class="mother col-12 down-20 xs-12 xs-down-30 md-12 md-down-30">
                <div class="col-12 shift-centre slide-up opacity xs-10 xs-off-1 md-10 md-off-1">
                    <span class="white px50 prosperR xs-px0 md-px40">CONTACT US</span>
                    <div>
                        <a href="index.php" class=" white prosperR">HOME </a><span class="white"> /CONTACT US</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-10 off-1 shift-centre down-3 xs-12 md-10 md-off-1 xs-down-5 md-down-5">
        <span class="px40 xs-px25 md-px30">Kindly fill this form to send us a message.</span>
    </div>

    <div class="col-5 off-4 down-3 md-10 md-off-2 xs-9 xs-off-2 xs-down-5 md-down-5">
        <div class="book-form">
            <form action="send.php" method="POST" class="form">
                <div class="form-group">
                    <input type="text" class="form-input" placeholder="Full Name" id="name" name="name" required>
                    <label for="name"></label>
                </div>
                <div class="form-group">
                    <input type="text" placeholder="Email Address" id="email" class="form-input" name="email" required>
                    <label for="email"></label>
                </div>
                <div class="form-group">
                    <input type="text" placeholder="Subject" id="subject" name="subject" class="form-input" required>
                    <label for="subject"></label>
                </div>
                <div class="form-group">
                    <input type="text" placeholder="Message" id="message" class="form-input" name="message">
