...
<body onscroll="navify()" onload="whatsappshow()">
    ...
    <div class="mother hidden-lg">
        <div class="mobile-nav-closed" id="mobileNav">
            ...
            <div>
                ...
                <a href="service.php" class="color-3">Our Services</a>
                <a href="apply.php" class="color-3">How to Apply</a>
                <a href="#" class="color-3">FAQs</a>
        ...
        <div class="dark-scarf-3">
            <div class="mother col-12 down-20 xs-12 xs-down-30 md-12 md-down-30">
                <div class="col-12 shift-centre slide-up opacity xs-10 xs-off-1 md-10 md-off-1">
                    <span class="white px50 prosperR xs-px0 md-px40">FAQs</span>
                    <div>
                        <a href="index.php" class=" white prosperR">HOME </a><span class="white"> /FAQs</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="mother xs-12 md-12 md-down-8 xs-down-5">
        <div class="col-10 off-1 shift-centre down-3 xs-12 md-10 md-off-1">
            <span class="px40 xs-px25 md-px30">These are answers questions students often ask. We trust that they will be of great help to you!</span>
        </div>
        <div class="col-10 off-1 xs-11 xs-off-1 xs-down-3 down-3 md-11 md-off-1 md-down-3 ">
            <span class="px25 xs-px20 md-px25">Do I need to be a graduate of a Nigerian University before i can apply?</span>
            <div class="col-10 xs-10">
                <span class="fade">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Et ipsam, repellat commodi a ipsa itaque dolores. Aut, dolorem! Consequuntur rerum voluptates voluptatum provident illum ipsum nostrum ullam esse. Excepturi, voluptates!</span>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="col-12 shift-centre down-3 xs-12 xs-down-10 md-12 md-down-10">
                <span class="px30 xs-px30 md-px40">Still have questions?</span>
            </div>
            <div class="col-12 shift-centre">
                <a href="" class="btn-sm bg-color-code-1 shm-vertical white prosperR">Contact Us Now!</a>
            </div>
        </div>
    </div>
