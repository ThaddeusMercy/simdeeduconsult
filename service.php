...
<head>
    ...
    <title>Services - Simdee Educational Consult</title>
</head>
...
<body onscroll="navify()" onload="whatsappshow()">
    ...
    <div class="mother hidden-lg">
        <div class="mobile-nav-closed" id="mobileNav">
            ...
            <div>
                <a href="index.php" class="color-3">Home</a>
                <a href="about.php" class="color-3">About Us</a>
                <a href="#" class="color-3">Our Services</a>
                <a href="apply.php" class="color-3">How to Apply</a>
                <a href="faqs.php" class="color-3">FAQs</a>
                <a href="contact.php" class="color-3"> Contact us</a>
            </div>
        </div>
    </div>
        ...
        <div class="dark-scarf-3">
            <div class="mother col-12 down-20 xs-12 xs-down-30 md-12 md-down-30">
                <div class="col-12 shift-centre slide-up opacity xs-10 xs-off-1 md-10 md-off-1">
                    <span class="white px50 prosperR xs-px0 md-px40">OUR SERVICES</span>
                    <div>
                        <a href="index.php" class=" white prosperR">HOME </a><span class="white"> /SERVICES</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="mother xs-12 md-12 md-down-8 xs-down-5">
        <div class="col-12 shift-centre down-3 xs-12">
            <span class="px45 fade xs-px30 md-px40">Why Choose Us?</span>
        </div>
    ...
    <div class="mother">
        <div class="col-12 shift-centre down-3 xs-down-10">
            <span class="px45 fade xs-px40 md-px40">What We Offer</span>
        </div>
        <div class="container">
            <div class="col-12 down-3 xs-12 xs-down-3 md-down-3">
                <div class="col-5 off-1 xs-6 xs-off-1 md-5 xs-6 xs-off-3">
                    <div class="img-container-3"><img src="images/congrats.jpg" alt=""></div>
                </div>
                <div class="col-4 off-1 down-3 md-4 md-off-2 md-down-3 xs-10 xs-off-2 xs-down-3">
                    <span class="px40 md-px30 xs-px30">Student Placement</span>
                </div>
                <div class="col-5 off-1 md-5 md-off-2 xs-11 xs-off-1">
                    <span>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Omnis quas, dicta adipisci cuapiente eligendi minima dicta distinctio adipisci iusto omnis, numquam libero similique eius dolor accusamus maxime consequatur?</span>
                </div>
            </div>
        </div>
    </div>

    <div class="mother md-12 md-down-8 xs-down-10 down-5 hidden-lg hidden-md">
        <div class="container">
            <div class="col-12 down-3 xs-12 xs-down-3 md-down-3">
                <div class="col-5 off-1 xs-6 xs-off-3 md-4">
                    <div class="img-container-3"><img src="images/congrats.jpg" alt=""></div>
                </div>
                <div class="col-4 off-1 down-3 md-4 md-off-2 md-down-3 xs-8 xs-off-2 xs-down-3">
                    <span class="px40 md-px30 xs-px30">Flight Bookings</span>
                </div>
                <div class="col-5 md-5 md-off-2 xs-11 xs-off-1">
                    <span>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Omnis quas, dicta adipisci cuapiente eligendi minima dicta distinctio adipisci iusto omnis, numquam libero similique eius dolor accusamus maxime consequatur?</span>
                </div>
            </div>
        </div>
    ...
    <div class="mother md-12 md-down-2 xs-down-10 down-2 hidden-xs">
        <div class="container">
            <div class="col-12 down-5 xs-12 xs-down-3 md-down-3">
                <div class="col-5 off-1 md-5 down-5">
                    <span class="px40 md-px30 off-2">Flight Bookings</span>
                    <div>
                        <span>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quo quibusdam unde provident isndae ipsum incidunt, voluptate aliquid explicabo qui esse exercitationem necessitatibus dolor facilis cupiditate earum laboriosam error?</span>
                    </div>

                </div>
                <div class="col-2 off-1 xs-8 xs-off-1 md-4 md-off-1">
                    <div class="img-container-3"><img src="images/congrats.jpg" alt=""></div>
                </div>
            </div>
        </div>
    ...
    <div class="mother">
        <div class="container">
            <div class="col-12 down-10 xs-12 xs-down-10 md-down-3">
                <div class="col-5 off-1 xs-6 xs-off-3 md-5">
                    <div class="img-container-3"><img src="images/congrats.jpg" alt=""></div>
                </div>
                <div class="col-4 off-1 down-3 md-4 md-off-2 md-down-3 xs-10 xs-off-2 xs-down-3">
                    <span class="px40 md-px30 xs-px30">Career Counsel</span>
                </div>
                <div class="col-5 off-1 md-5 md-off-2 xs-11 xs-off-1">
                    <span>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Omnis quas, dicta adipisci cuapiente eligendi minima dicta distinctio adipisci iusto omnis, numquam libero similique eius dolor accusamus maxime consequatur?</span>
                </div>
    ...
    <div class="mother md-12 md-down-8 xs-down-5 down-5 hidden-lg hidden-md">
        <div class="container">
            <div class="col-12 down-3 xs-12 xs-down-10 md-down-3">
                <div class="col-5 off-1 xs-6 xs-off-3 md-4">
                    <div class="img-container-3"><img src="images/congrats.jpg" alt=""></div>
                </div>
                <div class="col-4 off-1 down-3 md-4 md-off-2 md-down-3 xs-8 xs-off-2 xs-down-3">
    ...
    <div class="mother md-12 md-down-2 xs-down-5 down-2 hidden-xs">
        <div class="container">
            <div class="col-12 down-5 xs-12 xs-down-3 md-down-3">
                <div class="col-5 off-1 md-5 down-5">
                    <span class="px40 md-px30 off-2">Exam Preparation</span>
                    <div>
                        <span>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quo quibusdam unde provident isndae ipsum incidunt, voluptate aliquid explicabo qui esse exercitationem necessitatibus dolor facilis cupiditate earum laboriosam error?</span>
                    </div>
    ...
    <div class="mother down-10 xs-down-10 md-down-5">
        <div class="bg-footer">
                    ...
                    <div class="col-12 xs-12 md-12">
                        ...
                        <div class="col-3 down-3 xs-10 xs-off-1 xs-down-5 md-8 md-off-1 md-down-3">
                            <div class="col-8 off-3 down-10">
                                ...
                                <div>
                                    <a href="services.php" class="white">Our Services</a>
                                </div>
                                <div>
                                    <a href="apply.php" class="white">How to Apply</a>
                                </div>
                                <div>
                                    <a href="faqs.php" class="white">FAQs</a>
                                </div>
                                <div>
